        ...
        Repeater {
            ...
            delegate: Item {
                ...
                StyledRect {
                    ...
                    color: trayItemArea.containsMouse ? Colors.colors.primary : "transparent"
                    ...
                    onClicked: mouse => {
                        ...
                        if (delegateTray.modelData.hasMenu) {
                            ...
                            if (validWindow) {
                                ...
                                menuAnchor.anchor.rect = delegateTray.QsWindow.window.contentItem.mapFromItem(
                                    delegateTray, 0, delegateTray.height, delegateTray.width,
                                    delegateTray.width);
                                menuAnchor.open();
                            } else {
