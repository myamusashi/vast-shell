...
StyledRect {
    ...
    color: mArea.containsPress ? Themes.withAlpha(
                                     ...
                                     0.08) : mArea.containsMouse ? Themes.withAlpha(
                                                                       Themes.colors.on_surface,
                                                                       0.16) : "transparent"
    ...
    Dots {
        ...
        property int notificationCount: Notifs.notifications.listNotifications.length
                                        || 0
        ...
        MatIcon {
            color: {
                if (root.notificationCount > 0
                        && root.notificationCount !== null
                        && root.isDndEnable !== true)
