...
LazyLoader {
    ...
    component: PanelWindow {
        ...
        property var scaleMonitor: (monitor.scale === null || monitor.scale === undefined) ? 1.0 :
                                                                                             monitor.scale
            ...
            delegate: Flickable {
                ...
                StyledRect {
                    ...
                    color: delegateNotif.modelData.urgency === NotificationUrgency.Critical
                           ? Colors.colors.on_error : Colors.colors.surface
                    radius: 8
                    border.color: delegateNotif.modelData.urgency === NotificationUrgency.Critical
                                  ? Colors.colors.error : Colors.colors.outline
                        ...
                        Item {
                            ...
                            Loader {
                                ...
                                sourceComponent: StyledRect {
                                    ...
                                    color: delegateNotif.modelData.urgency === NotificationUrgency.Critical
                                           ? Colors.colors.error : delegateNotif.modelData.urgency
                                    ...
                                    Loader {
                                        ...
                                        sourceComponent: MatIcon {
                                            ...
                                            color: delegateNotif.modelData.urgency
                                                   === NotificationUrgency.Critical ? Colors.colors.on_error :
                                                                                      delegateNotif.modelData.urgency
                                                                                      === NotificationUrgency.Low
                                                                                      ? Colors.colors.on_surface :
                                                                                        Colors.colors.on_secondary_container
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                MatIcon {
                                    ...
                                    color: mArea.containsMouse ? Colors.withAlpha(Colors.dark.error, 0.4) :
                                                                 Colors.colors.error
                            ...
                            RowLayout {
                                ...
                                Repeater {
                                    ...
                                    delegate: StyledRect {
                                        ...
                                        color: actionMouse.pressed ? Colors.colors.primary_container :
                                                                     actionMouse.containsMouse
                                                                     ? Colors.colors.surface_container_highest :
                                                                       Colors.colors.surface_container_high

                                        border.color: actionMouse.containsMouse ? Colors.colors.primary :
                                        ...
                                        MouseArea {
                                            ...
                                            StyledRect {
                                                ...
                                                height: 0
                                                radius: width / 2
                                                color: Qt.rgba(Colors.colors.primary.r,
                                                               Colors.colors.primary.g,
                                                               Colors.colors.primary.b, 0.3)
                                                visible: false
                                                ...
                                                SequentialAnimation {
                                                    ...
                                                    PropertyAnimation {
                                                        target: ripple
                                                        property: "width"
                                                        to: Math.max(actionButton.width, actionButton.height)
                                                            * 2
                                                        duration: Appearance.animations.durations.normal * 1.2
                                                        easing.type: Easing.BezierSpline
                                                        easing.bezierCurve:
                                                        Appearance.animations.curves.standard
                                                    }
                                                    PropertyAnimation {
                                                        target: ripple
                                                        property: "height"
                                        ...
                                        StyledText {
                                            ...
                                            color: actionMouse.containsMouse
                                                   ? Colors.colors.on_primary_container :
                                                     Colors.colors.on_surface
                                            elide: Text.ElideRight
                                        }
