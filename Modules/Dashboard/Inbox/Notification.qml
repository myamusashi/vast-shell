                                ...
                                Loader {
                                    ...
                                    sourceComponent: StyledRect {
                                        ...
                                        color: flickDelegate.modelData.urgency
                                               === NotificationUrgency.Critical ? Colors.colors.error :
                                                                                  flickDelegate.modelData.urgency
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    MatIcon {
                                        ...
                                        color: mIcon.containsMouse ? Colors.withAlpha(Colors.dark.error, 0.4) :
                                                                     Colors.colors.error
                                    ...
                                    Repeater {
                                        ...
                                        delegate: StyledRect {
                                                ...
                                                StyledRect {
                                                    ...
                                                    SequentialAnimation {
                                                        ...
                                                        PropertyAnimation {
                                                            target: ripple
                                                            property: "width"
                                                            to: Math.max(actionButton.width,
                                                                         actionButton.height) * 2
                                            ...
                                            StyledText {
                                                ...
                                                font.weight: actionMouse.containsMouse ? Font.Medium :
                                                                                         Font.Normal
