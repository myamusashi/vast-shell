...
ColumnLayout {
    ...
    StyledRect {
        ...
        StyledRect {
            ...
            border.width: 1
            border.color: Qt.rgba(Colors.colors.secondary.r, Colors.colors.secondary.g,
                                  Colors.colors.secondary.b, 0.08)
        }
        ...
        ColumnLayout {
            ...
            StyledRect {
                ...
                color: Qt.rgba(Colors.colors.on_surface.r, Colors.colors.on_surface.g,
                               Colors.colors.on_surface.b, 0.15)
                radius: 16
